...
private  String material;
	...
	public String toString() {
		...
		return "Название цветка="+this.getName()+", стоимость="+ String.format("%.3f", this.getPrice())+" бел.руб.,"+", цвет бутона="+this.getColor()+" длина цветка="+this.getLength()+", дней как создали="+this.getProdactionDay()+", материал="+this.getMaterial();
